...
* add Claude Code harness for ManageSieveJ development ([86b282b](https://github.com/lenucksi/ManageSieveJ/commit/86b282b57cffa3859a911e9420ed252ef49bf8bd))
...
* add OpenSSF Scorecard security assessment workflow ([d93ec55](https://github.com/lenucksi/ManageSieveJ/commit/d93ec5586811f9a1155b63075c667c0117be0e75))
...
* enable SLSA build provenance attestation in CI workflow ([8a1134c](https://github.com/lenucksi/ManageSieveJ/commit/8a1134c9c74771340976c6c1f68f6383cf72a512))
...
* modernize repository with Java 21, CI/CD, comprehensive testing, and JitPack distribution ([d0922ae](https://github.com/lenucksi/ManageSieveJ/commit/d0922ae4e1a282dbfd2761955f5cc7a1da90c870))
...
* **client:** properly close InputStreamReader to prevent resource leak ([dfa2794](https://github.com/lenucksi/ManageSieveJ/commit/dfa2794c8e7158cd637d392eb3db7af30bddbd35))
...
* configure test compilation to work with Java modules ([ebb1ce4](https://github.com/lenucksi/ManageSieveJ/commit/ebb1ce437d3f53b1e30b35dd526d29b5d0fc0736))
...
* correct GitHub Actions references to resolve download failures ([f2c9e19](https://github.com/lenucksi/ManageSieveJ/commit/f2c9e19d816602dc05f7994646c14c6d33111d48))
...
* Correct release-please XML field from 'xmlpath' to 'xpath' ([048f8de](https://github.com/lenucksi/ManageSieveJ/commit/048f8de51ec5249bc13da5e98b7499964a7ea31c))
...
* correct workflow branch triggers from 'main' to 'master' ([2995bca](https://github.com/lenucksi/ManageSieveJ/commit/2995bca7afd3fe8391d267cf38f1d91428cc3435))
...
* resolve CI workflow failures (Java compatibility, action path, OWASP caching) ([baec470](https://github.com/lenucksi/ManageSieveJ/commit/baec4700e384e5ce4681d06ebb7d36e7eee13430))
...
* **security:** apply critical security fixes for log sanitization and resource leaks ([a118b0f](https://github.com/lenucksi/ManageSieveJ/commit/a118b0f58ac546a40ec8eab3d0cd264c3fe91b08))
...
* **security:** apply critical security fixes for v0.4.0 release ([ff0bfa5](https://github.com/lenucksi/ManageSieveJ/commit/ff0bfa57b291deb13a000cffe02bca0883835ff5))
...
* **security:** remove insecure TrustManager from example code (Alert [#2](https://github.com/lenucksi/ManageSieveJ/issues/2)) ([80e2ca1](https://github.com/lenucksi/ManageSieveJ/commit/80e2ca18527a4e5397a176e86e6e33b0bf5b3998))
...
* unify CodeQL workflows into single enhanced workflow ([dd3fe05](https://github.com/lenucksi/ManageSieveJ/commit/dd3fe05e3f1633fc8c322eb5f2ec9dacb8738ea7))
